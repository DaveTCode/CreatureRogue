...
class BattleData:
    def __init__(
        self,
        game_data: GameData,
        player_creature: BattleCreature,
        computer_ai: Any,
        trainer_creature: BattleCreature | None = None,
        wild_creature: BattleCreature | None = None,
    ):
    ...
    def defending_creature(self) -> BattleCreature | None:
        """

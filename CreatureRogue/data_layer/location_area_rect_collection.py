...
class LocationAreaRectCollection:
    ...
    def __init__(self):
        self.by_id = {} # type: dict[int, LocationAreaRect]

    def add_location_area_rect(self, rect: LocationAreaRect):
        """
    ...
    def get_location_area_by_position(self, x: int, y: int) -> int | None:
        """

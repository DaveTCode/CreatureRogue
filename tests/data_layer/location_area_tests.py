...
class LocationAreaTests(unittest.TestCase):
    def test_str_no_name(self):
        ...
        """
        l = LocationArea(identifier="", name="", location=Location(identifier="", name="", region=Region(identifier="", name="")), walk_encounters=[])
    ...
    def test_str_name(self):
        ...
        matches the name.
        """
        l = LocationArea(identifier="", name="test", location=Location(identifier="", name="", region=Region(identifier="", name="")), walk_encounters=[])
    ...
    def test_encounter_returned_if_one_exists(self):
        ...
        """
        l = LocationArea(identifier="", name="test", location=Location(identifier="", name="", region=Region(identifier="", name="")),
